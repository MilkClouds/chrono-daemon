...
- [0006 — In-process v0 with a reserved transport-adapter slot](0006-in-process-v0-transport-adapter-slot.md)
- [0007 — `anyio` is the only runtime dependency](0007-anyio-only-runtime-dependency.md)
- [0008 — Sim-time-aware logging and supervisor diagnostics (v0.1)](0008-sim-aware-logging-and-supervisor-diagnostics.md)
