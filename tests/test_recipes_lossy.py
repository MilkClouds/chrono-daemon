...
from chrono_daemon import Channel, open_channel
from chrono_daemon.recipes.lossy import CoalesceSend, DropNewestSend, DropOldestSend
...
async def test_lossy_wrapper_aclose_closes_underlying() -> None:
    ...
    assert await ch.recv.receive() == 1
    from chrono_daemon import EndOfStream
