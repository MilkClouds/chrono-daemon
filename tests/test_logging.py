...
from chrono_daemon import Context, Daemon, SimClock, Supervisor
...
async def test_logger_records_carry_sim_time(caplog: pytest.LogCaptureFixture) -> None:
    ...
    with caplog.at_level(logging.INFO, logger="chrono_daemon"):
...
async def test_explicit_extra_sim_time_is_not_overwritten() -> None:
    ...
    base = logging.getLogger("test_chrono_daemon.logger_passthrough")
