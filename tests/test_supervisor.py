...
from chrono_daemon import Context, Daemon, DaemonError, DaemonHealth, RestartPolicy, SimClock, Supervisor
...
async def test_add_rejects_daemon_factory_with_clear_error() -> None:
    ...
    from chrono_daemon import daemon as daemon_decorator
